...
public class OrderService 
{
	...
	{ 
		String output = orderObj.insertOrder(orderCode, orderType, customerID, customerName, customerContact,  totalAmount, cardNo, expDate, cvvNo); 
		return output; 
	}	
	...
	{ 
		...
		//Read the values from the JSON object
		 ...
		 String expDate = orderObject.get("expDate").getAsString(); 
		 String cvvNo = orderObject.get("cvvNo").getAsString(); 
		 
		// String output = orderObj.updateOrder(orderData);
		 
		 String output = orderObj.updateOrder(orderID, orderCode, orderType, customerID, customerName, customerContact, totalAmount, cardNo, expDate, cvvNo); 
		 return output; 
	}
